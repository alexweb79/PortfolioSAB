module.exports = function() {
    ...
    function createSliderChangeNav(className, classOverlay, classDownOrUp) {
        ...
        navLink.innerHTML = '<svg viewbox="0 0 42.736 27.435"><use xlink:href="../assets/images/icons/sprite_portf_arrow.svg#arrow_down"></use></svg>';
    ...
    function createSliderMainPreview() {
        ...
        previewBtn.classList.add('main-preview-btn', 'sites-link__sites-button');
        previewBtnLink.classList.add('btn', 'btn--preview', 'sites-button__link');
        previewBtnLink.innerHTML = '<span>Посмотреть сайт</span>'
